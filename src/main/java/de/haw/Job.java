...
public class Job {
  ...
  public static void main(String[] args) throws Exception {
    ...
    semiParams.setMaxIterations(parameter.getInt("m", 10));
    semiParams.setInitScore(parameter.getDouble("i", 1.0));
    semiParams.setFactor(parameter.getDouble("f", 0.2));
    semiParams.setTopXOfClusters(parameter.getInt("x", 6));
    semiParams.setClusterCapacity(parameter.getInt("c", 10));
